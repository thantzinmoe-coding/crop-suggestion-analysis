...
const translations = {
  en: {
    ...
    "auth.loginSubtitle": "Sign in to access your crop-Ai dashboard",
    "auth.registerSubtitle": "Join crop-Ai and start managing your farm",
  ...
  my: {
    ...
    "nav.community": "တောင်သူအသိုင်းအဝိုင်း",
    ...
    "auth.loginSubtitle": "သင့် crop-Ai ဒက်ရှ်ဘုတ်သို့ ဝင်ရောက်ရန် အကောင့်ဝင်ပါ",
    "auth.registerSubtitle": "crop-Ai တွင်ပါဝင်ပြီး သင့်လယ်ယာကို စီမံခန့်ခွဲပါ",
